...
.lcomm FD_IN, 8			# 8 bytes for input file descriptor (64-bit)
.lcomm FD_OUT, 8		# 8 bytes for output file descriptor (64-bit)
...
mov FD_IN, %rdi	#file descriptor (first argument)
...
mov FD_OUT, %rdi	#file descriptor (first argument)
mov $BUFFER_DATA, %rsi		#buffer location (second argument)
syscall				#call kernel
