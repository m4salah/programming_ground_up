...
ERR_MSG: .string "Error occured...\n"
.equ ERR_MSG_LEN, . - err - 1
...
#PURPOSE: This function check the error and if there is error 
#	  it write it to the stderr then exit the program
#
#INPUT:	  First parameter (%rdi) is the err code we want to check
#
#OUTPUT:  It write to the stderr if there is error then exit
#
#VARIABLES:
